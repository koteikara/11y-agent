...
const TASKS = {
  ...
  "heading-review": {
    systemPrompt:
      ...
      "「【とき】」「【ところ】」「[NOTE]」のように、段落全体が短いカッコ書きのラベルだけで構成されている場合、そのラベル自体が既に見出し相当の役割を果たしています。そのような段落をbefore_block_idに指定し、ラベルと同じ意味の見出し文言(例:「【とき】」に対する「開催日時」)を提案しないでください。内容が重複します。" +
