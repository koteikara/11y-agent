...
cms_auto: false
origin: manual
michecker_check_ids: ["C_48.0", "C_48.1", "C_48.2", "C_48.3", "C_48.4", "C_48.5", "C_48.6", "C_48.7", "C_48.8", "C_600.9", "C_600.10", "C_33.0", "C_33.1", "C_33.2", "C_34.0", "C_25.2", "C_25.4"]
...
`img`要素の`longdesc`属性、`table`要素の`summary`属性も同様に廃止済みのため、内容を確認・改善するのではなく一律で除去する。表の概要は`summary`属性ではなく`caption`要素で提供する（`table/caption.md`）。
